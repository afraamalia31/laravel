        ...
        <div class="row">
          <div class="col-12 col-sm-8 offset-sm-2 col-md-6 offset-md-3 col-lg-6 offset-lg-3 col-xl-4 offset-xl-4">
            <div class="login-brand">
              <img src="stisla-master/assets/img/stisla-fill.svg" alt="logo" width="100" class="shadow-light rounded-circle">
            </div>
            ...
            <div class="card card-primary">
              ...
              <div class="card-body">
                <form method="POST" action="{{ url('/proses-login') }}" class="needs-validation" novalidate="">
                    @csrf
